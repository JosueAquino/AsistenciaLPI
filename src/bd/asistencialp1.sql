...
-- 
-- Servidor: localhost
-- Tiempo de generación: 14-08-2016 a las 18:43:56
...
-- 
CREATE DATABASE `basereserva` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `basereserva`;
...
INSERT INTO `cliente` VALUES (2, '123');
...
-- 
-- Volcar la base de datos para la tabla `consumo`
-- 

INSERT INTO `consumo` VALUES (1, 1, 2, 2.00, 5.00, 'Aceptado');
...
-- 
-- Volcar la base de datos para la tabla `habitacion`
-- 

INSERT INTO `habitacion` VALUES (1, '101', '1', 'Primera habitación, comoda y acogedor', 'Tiene baño personal, tv cable, internet', 30.00, 'Disponible', 'Matrimonial');
...
INSERT INTO `pago` VALUES (1, 1, 'Boleta', '123', 0.18, 30.00, '2016-07-13', '2016-07-13');
...
INSERT INTO `persona` VALUES (1, 'Josue', 'Aquino', 'Mauricio', 'DNI', '71337280', 'Carapongo', '', 'josueaquino@upeu.edu.pe');
INSERT INTO `persona` VALUES (2, 'Claudia', ' Portocarrero', 'Sucio', 'DNI', '12345678', 'en su casa', '14568972', '');
INSERT INTO `persona` VALUES (3, 'Sindu', 'mas', 'na', 'LM', '69810372', 'vcc', '1234578', 'cxc');
...
INSERT INTO `producto` VALUES (1, 'Papel Higienico', 'Elite', 'UND', 1.00);
INSERT INTO `producto` VALUES (2, 'galleta Soda', 'Salada', 'UND', 5.00);
...
INSERT INTO `reserva` VALUES (1, 1, 2, 1, 'Reserva', '2016-07-13', '2016-07-15', '2016-07-16', 30.00, 'Pagada');
...
INSERT INTO `trabajador` VALUES (1, 254.00, 'Administrador', 'admin', 'admin', 'A');
INSERT INTO `trabajador` VALUES (3, 260.00, 'Digitador', 'sindymas', '2016', 'A');
-- 
-- Base de datos: `bdhotel`
-- 
CREATE DATABASE `bdhotel` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdhotel`;
...
-- 
-- Base de datos: `bdhotelsatelite`
-- 
CREATE DATABASE `bdhotelsatelite` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdhotelsatelite`;
...
CREATE TABLE `reserva` (
  ...
  PRIMARY KEY  (`idreserva`),
  KEY `fk_reserva_habitacion_idx` (`idhabitacion`),
  KEY `fk_reserva_trabajador_idx` (`idusuario`),
...
-- 
-- Base de datos: `bdhotelveneno`
-- 
CREATE DATABASE `bdhotelveneno` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdhotelveneno`;
...
INSERT INTO `cliente` VALUES (2, 'Josue', 'Aquino ', 977948170, 18);
INSERT INTO `cliente` VALUES (3, 'Josue', 'Aquino ', 977948172, 18);
...
INSERT INTO `usuario` VALUES (1, 'Josue', 'Aquino', 'josueaquino', '2016');
-- 
-- Base de datos: `bdreservahotelj&s`
-- 
CREATE DATABASE `bdreservahotelj&s` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdreservahotelj&s`;
...
INSERT INTO `cliente` VALUES (5, 'Josue', 'Aquino', 977948170, 18);
INSERT INTO `cliente` VALUES (17, 'Lenoscomoco', 'Muricio', 19191919, 18);
INSERT INTO `cliente` VALUES (7, 'Yomi ', 'Medrano', 324896157, 18);
INSERT INTO `cliente` VALUES (8, 'Steyci', 'Pomalia', 324896157, 18);
INSERT INTO `cliente` VALUES (9, 'Lourdes', 'Huicho', 324896158, 20);
INSERT INTO `cliente` VALUES (10, 'Luiza', 'Ramirez', 324896165, 21);
INSERT INTO `cliente` VALUES (11, 'Yomii', 'Mercado', 324896157, 18);
INSERT INTO `cliente` VALUES (12, 'Zulema', 'centeno', 30258946, 23);
INSERT INTO `cliente` VALUES (13, 'Sandra', 'Navarro', 98745892, 35);
INSERT INTO `cliente` VALUES (14, 'Nataly', 'Matos', 789230145, 18);
INSERT INTO `cliente` VALUES (15, 'Geraldine', 'Vega', 978635421, 18);
INSERT INTO `cliente` VALUES (16, 'Jenny', 'Montes', 965874265, 18);
...
INSERT INTO `habitacion` VALUES (7, 7, 30.00, 'Ocupado');
INSERT INTO `habitacion` VALUES (8, 10, 20.00, 'Ocupado');
INSERT INTO `habitacion` VALUES (9, 9, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (10, 10, 20.00, 'Ocupado');
INSERT INTO `habitacion` VALUES (11, 10, 20.00, 'Ocupado');
INSERT INTO `habitacion` VALUES (12, 12, 20.00, 'Ocupado');
INSERT INTO `habitacion` VALUES (13, 13, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (15, 15, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (16, 16, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (17, 17, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (18, 18, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (19, 19, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (20, 20, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (21, 21, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (22, 22, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (23, 23, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (24, 24, 20.00, 'Disponible');
INSERT INTO `habitacion` VALUES (25, 25, 20.00, 'Disponible');
...
CREATE TABLE `reserva` (
  ...
  `fecha_ingreso` date NOT NULL,
  `fecha_salida` date NOT NULL,
  `costo_alojamiento` double(7,2) NOT NULL,
  `estado` varchar(15) NOT NULL,
  PRIMARY KEY  (`idreserva`)
...
INSERT INTO `reserva` VALUES (3, 1, 6, 2, '2016-07-05', '2016-07-21', 40.00, 'Pagado');
INSERT INTO `reserva` VALUES (2, 3, 6, 1, '2016-07-01', '2016-07-27', 50.00, 'Pagado');
INSERT INTO `reserva` VALUES (4, 2, 3, 1, '2016-07-02', '2016-07-22', 40.00, 'Pagado');
INSERT INTO `reserva` VALUES (5, 7, 3, 15, '2016-07-11', '2016-07-10', 20.00, 'deuda');
INSERT INTO `reserva` VALUES (6, 8, 6, 14, '2016-07-12', '2016-07-12', 12.00, 'deuda');
INSERT INTO `reserva` VALUES (7, 12, 3, 13, '2016-07-03', '2016-07-07', 50.00, 'deuda');
INSERT INTO `reserva` VALUES (8, 9, 6, 11, '2016-07-04', '2016-07-08', 80.00, 'pagado');
INSERT INTO `reserva` VALUES (9, 13, 6, 9, '2016-07-06', '2016-07-12', 20.00, 'pagado');
INSERT INTO `reserva` VALUES (10, 15, 3, 8, '2016-07-11', '2016-07-11', 20.00, 'pagado');
INSERT INTO `reserva` VALUES (11, 18, 3, 12, '2016-07-10', '2016-07-10', 20.00, 'deuda');
INSERT INTO `reserva` VALUES (12, 3, 3, 6, '2016-07-09', '2016-07-09', 40.00, 'pagado');
INSERT INTO `reserva` VALUES (13, 14, 6, 7, '2016-07-06', '2016-07-08', 40.00, 'pagado');
...
INSERT INTO `usuario` VALUES (3, 'sindy', 'epiquien', 'raquel', '1002');
INSERT INTO `usuario` VALUES (6, 'Josue', 'Aquino', 'joss', '123');
INSERT INTO `usuario` VALUES (12, 'liz', 'saravia', 'lizi', '123');
INSERT INTO `usuario` VALUES (13, '', '', '', '');
-- 
-- Base de datos: `bdtienda`
-- 
CREATE DATABASE `bdtienda` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdtienda`;
-- 
-- Base de datos: `cafetinupeu`
-- 
CREATE DATABASE `cafetinupeu` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cafetinupeu`;
...
-- Base de datos: `josue`
-- 
CREATE DATABASE `josue` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `josue`;
-- 
-- Base de datos: `mysql`
-- 
...
-- 
CREATE DATABASE `registro` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `registro`;
...
CREATE TABLE `registro` (
  ...
  KEY `Nombre` (`Nombre`,`Apellido`,`DNI`,`Edad`,`Clase`,`Unidad`,`Correo Electronico`,`Telefono`,`Observacion`),
...
INSERT INTO `registro` VALUES (2, 'josue', 'aquino', 5454545, 23, 'aacsc', 'vchscv', 'shvcsh', 1212, 'vhcvsh');
-- 
-- Base de datos: `test`
-- 
...
INSERT INTO `cliente` VALUES ('CC0001', 'Sindy', 'Epiquien', 'F', '12345678', '', '', '', '');
INSERT INTO `cliente` VALUES ('CC0002', 'Josue', 'Aquino', 'M', '71337280', '977948170', '', '', '');
...
INSERT INTO `producto` VALUES ('CP0001', 'Zapolio', '1.50', '10');
INSERT INTO `producto` VALUES ('CP0002', 'sd', '2', '1');
